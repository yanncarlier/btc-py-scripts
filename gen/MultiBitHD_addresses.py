...
mnemonic, num_addresses = parse_derivation_arguments("Generate MultiBit HD-style P2PKH addresses from a BIP39 mnemonic.")
...
try:
    ...
    print(json.dumps({"mnemonic_phrase": mnemonic, "passphrase": passphrase, "seed_hex": seed_bytes.hex(), "address_type": "MultiBit HD-style P2PKH", "account_extended_public_key": account_xpub, "addresses": addresses}, indent=2))
